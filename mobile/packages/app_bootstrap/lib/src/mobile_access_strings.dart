...
final class MobileAccessStrings {
  ...
  factory MobileAccessStrings.forLocale(Locale locale) => switch (locale
      .languageCode
      .toLowerCase()) {
    'bn' => const MobileAccessStrings._(
      ...
      authRequired:
          'আপনার অ্যাকাউন্ট অ্যাক্সেস রিফ্রেশ করতে আবার সাইন ইন করুন।',
      ...
      configurationFailurePrefix: 'এই বিল্ড নিরাপদভাবে সংযোগ করতে পারছে না।',
    ...
    'ar' => const MobileAccessStrings._(
      ...
      buildNotConfigured: 'هذا الإصدار من التطبيق غير مهيأ لخدمة هوية المدرسة.',
      checkingSecureAccountAccess: 'جارٍ التحقق من الوصول الآمن للحساب…',
      chooseGrantedAccess:
      ...
      configurationFailurePrefix: 'يتعذر على هذا الإصدار الاتصال بأمان.',
    ...
    _ => const MobileAccessStrings._(
      ...
      userCancelled: 'Sign-in was cancelled. No account changes were made.',
    ),
  };
