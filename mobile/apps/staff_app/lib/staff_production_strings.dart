...
final class StaffProductionStrings {
  ...
  factory StaffProductionStrings.forLocale(
    Locale locale,
    ...
    SchoolLanguage.bangla => const StaffProductionStrings._(
      ...
      assignedRosterUnverified: 'এই ক্লাসের নির্ধারিত রোস্টার যাচাই করা যায়নি।',
      ...
      encryptedQueueUnavailable: 'এনক্রিপ্টেড উপস্থিতি কিউ খোলা যায়নি।',
      ...
      noStudentsInAuthorizedRoster: 'অনুমোদিত রোস্টারে কোনো শিক্ষার্থী নেই।',
    ...
    SchoolLanguage.arabic => const StaffProductionStrings._(
      ...
      assignedRosterUnverified: 'تعذر التحقق من القائمة المعينة لهذه الحصة.',
      attendanceCaptureUnavailable:
      ...
      encryptedQueueUnavailable: 'تعذر فتح قائمة انتظار الحضور المشفرة.',
      excused: 'بعذر',
      late: 'متأخر',
      ...
      noStudentsInAuthorizedRoster: 'لا يوجد طلاب في القائمة المصرح بها.',
      noSubstituteClassDataShown: 'لم يتم عرض بيانات صف بديلة',
      noTeacherMeetingsAssigned: 'لا توجد حصص للمعلم معينة لهذا اليوم.',
      onlyAssignedRosters: 'يمكن فتح قوائم الحصص المعينة فقط على هذا الجهاز.',
      openAssignedMeetingFirst: 'افتح حصة معينة من صفحة اليوم أولًا.',
      present: 'حاضر',
    ...
    SchoolLanguage.english => const StaffProductionStrings._(
      ...
      openAssignedMeetingFirst: 'Open an assigned meeting from Today first.',
      present: 'Present',
