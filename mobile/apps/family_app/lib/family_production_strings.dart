...
final class FamilyProductionStrings {
  ...
  factory FamilyProductionStrings.forLocale(Locale locale) =>
      switch (SchoolLocalePolicy.resolve(locale)) {
        SchoolLanguage.bangla => const FamilyProductionStrings._(
          ...
          noPublishedAttendanceSummary:
              'কোনো প্রকাশিত উপস্থিতির সারাংশ নেই।',
          noPublishedResults: 'কোনো প্রকাশিত ফলাফল নেই।',
          noPublishedTimetableItems:
              'কোনো প্রকাশিত সময়সূচির আইটেম নেই।',
          ...
          unableToLoadFamilyInformation:
              'ফ্যামিলি তথ্য লোড করা যায়নি',
