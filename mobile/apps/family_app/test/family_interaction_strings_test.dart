...
void main() {
  test('provides reviewed Family interaction copy for English Bangla and Arabic', () {
    final english = FamilyInteractionStrings.forLocale(const Locale('en', 'GB'));
    final bangla = FamilyInteractionStrings.forLocale(const Locale('bn', 'BD'));
    final arabic = FamilyInteractionStrings.forLocale(const Locale('ar', 'SA'));
  ...
  test('localizes server-owned interaction statuses without changing values', () {
    expect(
  ...
  test('keeps authoritative revisions and policy versions in localized sentences', () {
    expect(
  ...
  test('falls back to English for unsupported locales', () {
    final strings = FamilyInteractionStrings.forLocale(const Locale('fr', 'FR'));
