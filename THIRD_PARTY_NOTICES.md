...
| @typescript-eslint/eslint-plugin | 8.67.0 | MIT | yes | no |
| @typescript-eslint/eslint-plugin/node_modules/ignore | 7.0.6 | MIT | yes | no |
| @typescript-eslint/parser | 8.67.0 | MIT | yes | no |
| @typescript-eslint/project-service | 8.67.0 | MIT | yes | no |
| @typescript-eslint/scope-manager | 8.67.0 | MIT | yes | no |
| @typescript-eslint/tsconfig-utils | 8.67.0 | MIT | yes | no |
| @typescript-eslint/type-utils | 8.67.0 | MIT | yes | no |
| @typescript-eslint/types | 8.67.0 | MIT | yes | no |
| @typescript-eslint/typescript-estree | 8.67.0 | MIT | yes | no |
| @typescript-eslint/utils | 8.67.0 | MIT | yes | no |
| @typescript-eslint/visitor-keys | 8.67.0 | MIT | yes | no |
...
| typescript-eslint | 8.67.0 | MIT | yes | no |
